...
=============================
The Guide Style Guide - DRAFT
=============================

.. note:: This document is attributed to Kenneth Reitz's excellent Python
   Guide. We reference it here until the OpenHatch Style Guide is completed
   since we like the conciseness and consistency of this style guide's
   approach.
...
avoid cluttering the `todo-list-ref`, use a single ``todo`` for stub
