...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnnotatedBug.project'
        db.add_column('bugsets_annotatedbug', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Project'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnnotatedBug.project'
        db.delete_column('bugsets_annotatedbug', 'project_id')
