...
from mysite.missions.git import views, helpers
...
class GitViewTests(TwillTests):
    ...
    def test_do_checkout_mission_correctly(self):
        ...
        self.assert_(helpers.mission_completed(paulproteus, 'git_checkout'))
    ...
    def test_do_git_description_mission_incorrectly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'git_config'))
    ...
    def test_do_git_description_mission_correctly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertTrue(helpers.mission_completed(paulproteus, 'git_config'))
    ...
    def test_do_rebase_mission_incorrectly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'git_rebase'))
    ...
    def test_do_diff_mission_correctly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assert_(helpers.mission_completed(paulproteus, 'git_diff'))
    ...
    def test_do_diff_mission_incorrectly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'git_diff'))
