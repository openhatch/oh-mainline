...
from mysite.missions.svn import views, helpers
...
class SvnBackendTests(TestCase):
    ...
    def test_repo_reset(self):
        ...
        try:
            ...
            helpers.SvnRepository(random_name).reset()
...
class SvnViewTests(TwillTests):
    ...
    def test_do_checkout_mission_correctly(self):
        ...
        try:
            ...
            self.assert_(helpers.mission_completed(paulproteus, 'svn_checkout'))
        finally:
    ...
    def test_do_checkout_mission_incorrectly(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'svn_checkout'))
    ...
    def test_do_diff_mission_correctly(self):
        ...
        try:
            ...
            subprocess.check_call(['svn', 'checkout', response.context['checkout_url'], checkoutdir])
            new_contents = open(os.path.join(helpers.get_mission_data_path('svn'),
            ...
            paulproteus = Person.objects.get(user__username='paulproteus')
            self.assert_(helpers.mission_completed(paulproteus, 'svn_diff'))
    ...
    def test_submit_empty_diff_does_not_crash(self):
        ...
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'svn_diff'))
...
def mock_get_changes_good(repo, txn):
    return [('U', 'trunk/'+helpers.SvnCommitMission.SECRET_WORD_FILE),
            ('U', 'trunk/'+helpers.SvnCommitMission.FILE_TO_BE_PATCHED)]
...
def mock_get_file_good(repo, txn, filename):
    if filename == 'trunk/'+helpers.SvnCommitMission.SECRET_WORD_FILE:
        return helpers.SvnCommitMission.NEW_SECRET_WORD+'\n'
    elif filename == 'trunk/'+helpers.SvnCommitMission.FILE_TO_BE_PATCHED:
        return open(helpers.SvnCommitMission.NEW_CONTENT).read()
    else:
...
def mock_get_file_bad_readme(repo, txn, filename):
    if filename == 'trunk/'+helpers.SvnCommitMission.FILE_TO_BE_PATCHED:
...
class SvnCommitHookTests(DjangoTestCase):
    ...
    def setUp(self):
        ...
        helpers.set_mission_completed(Person.objects.get(user__username='paulproteus'), 'svn_diff')

    def assert_commit_allowed(self):
        helpers.SvnCommitMission.pre_commit_hook('/fake/repository/path', 'fake-transaction-id')
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assert_(helpers.mission_completed(paulproteus, 'svn_commit'))

    def assert_commit_not_allowed(self):
        try:
            helpers.SvnCommitMission.pre_commit_hook('/fake/repository/path', 'fake-transaction-id')
            self.fail('No exception was raised.')
        except helpers.IncorrectPatch:
            pass
        paulproteus = Person.objects.get(user__username='paulproteus')
        self.assertFalse(helpers.mission_completed(paulproteus, 'svn_commit'))

    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_good)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    ...
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_good)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_bad)
    def test_reject_commit_without_log_message(self):
        self.assert_commit_not_allowed()

    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_good)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_bad_secret_word)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    ...
    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_good)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_bad_readme)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    def test_reject_commit_with_bad_readme(self):
        self.assert_commit_not_allowed()

    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_bad_modifies_extra_file)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    ...
    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_bad_skips_file)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    ...
    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_bad_adds_file)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
    ...
    @mock.patch('mysite.missions.svn.helpers.get_username_for_svn_txn', mock_get_username)
    @mock.patch('mysite.missions.svn.helpers.get_changes_for_svn_txn', mock_get_changes_bad_removes_file)
    @mock.patch('mysite.missions.svn.helpers.get_file_for_svn_txn', mock_get_file_good)
    @mock.patch('mysite.missions.svn.helpers.get_log_for_svn_txn', mock_get_log_good)
