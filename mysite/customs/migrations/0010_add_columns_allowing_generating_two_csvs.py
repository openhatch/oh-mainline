...
class Migration:
    ...
    models = {
        ...
        'customs.roundupbugtracker': {
            ...
            'when_generating_the_component_csv_get_only_these_components': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'}),
            'when_generating_the_keyword_csv_get_only_these_keywords': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '50', 'null': 'True'})
        },
        'customs.webresponse': {
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
