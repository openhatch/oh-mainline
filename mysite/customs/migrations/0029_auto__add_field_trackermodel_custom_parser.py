...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackerModel.custom_parser'
        db.add_column('customs_trackermodel', 'custom_parser', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrackerModel.custom_parser'
        db.delete_column('customs_trackermodel', 'custom_parser')
