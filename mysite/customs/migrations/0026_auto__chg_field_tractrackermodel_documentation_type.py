...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TracTrackerModel.documentation_type'
        db.alter_column('customs_tractrackermodel', 'documentation_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10))


    def backwards(self, orm):
        
        # Changing field 'TracTrackerModel.documentation_type'
        db.alter_column('customs_tractrackermodel', 'documentation_type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
