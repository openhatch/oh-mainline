...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackerModel.created_for_project'
        db.add_column('customs_trackermodel', 'created_for_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.Project'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TrackerModel.created_for_project'
        db.delete_column('customs_trackermodel', 'created_for_project_id')
