...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TracTrackerModel'
        db.create_table('customs_tractrackermodel', (
            ...
            ('documentation_type', self.gf('django.db.models.fields.CharField')(default=None, max_length=10, null=True)),
            ...
            ('old_trac', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('customs', ['TracTrackerModel'])

        # Adding model 'TracQueryModel'
        db.create_table('customs_tracquerymodel', (
            ...
            ('tracker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customs.TracTrackerModel'])),
        ))
        db.send_create_signal('customs', ['TracQueryModel'])


    def backwards(self, orm):
        
        # Deleting model 'TracTrackerModel'
        db.delete_table('customs_tractrackermodel')

        # Deleting model 'TracQueryModel'
        db.delete_table('customs_tracquerymodel')
