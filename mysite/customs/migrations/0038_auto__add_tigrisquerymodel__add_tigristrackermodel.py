...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TigrisQueryModel'
        db.create_table('customs_tigrisquerymodel', (
            ...
            ('tracker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customs.TigrisTrackerModel'])),
        ))
        db.send_create_signal('customs', ['TigrisQueryModel'])

        # Adding model 'TigrisTrackerModel'
        db.create_table('customs_tigristrackermodel', (
            ...
            ('documentation_type', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('documentation_text', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True)),
        ))
        db.send_create_signal('customs', ['TigrisTrackerModel'])


    def backwards(self, orm):
        
        # Deleting model 'TigrisQueryModel'
        db.delete_table('customs_tigrisquerymodel')

        # Deleting model 'TigrisTrackerModel'
        db.delete_table('customs_tigristrackermodel')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 27, 14, 39, 5, 787500)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 27, 14, 39, 5, 787409)'}),
        ...
        'customs.tigrisquerymodel': {
            'Meta': {'object_name': 'TigrisQueryModel', '_ormbases': ['customs.TrackerQueryModel']},
            'tracker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['customs.TigrisTrackerModel']"}),
            'trackerquerymodel_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['customs.TrackerQueryModel']", 'unique': 'True', 'primary_key': 'True'})
        },
        'customs.tigristrackermodel': {
            'Meta': {'object_name': 'TigrisTrackerModel', '_ormbases': ['customs.TrackerModel']},
            'base_url': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '200'}),
            'bitesized_text': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
            'bitesized_type': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            'documentation_text': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200', 'blank': 'True'}),
