...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JiraQueryModel.url'
        db.delete_column('customs_jiraquerymodel', 'url')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'JiraQueryModel.url'
        raise RuntimeError("Cannot reverse this migration. 'JiraQueryModel.url' and its values cannot be restored.")
