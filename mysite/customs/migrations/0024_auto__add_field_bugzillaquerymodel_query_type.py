...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BugzillaQueryModel.query_type'
        db.add_column('customs_bugzillaquerymodel', 'query_type', self.gf('django.db.models.fields.CharField')(default='xml', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BugzillaQueryModel.query_type'
        db.delete_column('customs_bugzillaquerymodel', 'query_type')
