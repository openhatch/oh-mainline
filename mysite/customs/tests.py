...
try:
    ...
    from bugimporters.google import GoogleCodeBugImporter, GoogleBugParser
...
@skipIf(GoogleCodeBugImporter is None, "To run these tests, you must install lxml. See ADVANCED_INSTALLATION.mkd for more.")
