...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.resume'
        db.add_column('profile_person', 'resume', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.resume'
        db.delete_column('profile_person', 'resume')
