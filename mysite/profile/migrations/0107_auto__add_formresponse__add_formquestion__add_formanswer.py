...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profile_formresponse', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.FormQuestion'])),
            ('value', self.gf('django.db.models.fields.CharField')(default='', max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal('profile', ['FormResponse'])

        # Adding model 'FormQuestion'
        db.create_table('profile_formquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('profile', ['FormQuestion'])

        # Adding model 'FormAnswer'
        db.create_table('profile_formanswer', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.FormQuestion'])),
            ('value', self.gf('django.db.models.fields.CharField')(default='', max_length=150, null=True, blank=True)),
        ))
        db.send_create_signal('profile', ['FormAnswer'])

        # Adding M2M table for field response on 'Person'
        db.create_table('profile_person_response', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profile.person'], null=False)),
            ('formresponse', models.ForeignKey(orm['profile.formresponse'], null=False))
        ))
        db.create_unique('profile_person_response', ['person_id', 'formresponse_id'])


    def backwards(self, orm):
        
        # Deleting model 'FormResponse'
        db.delete_table('profile_formresponse')

        # Deleting model 'FormQuestion'
        db.delete_table('profile_formquestion')

        # Deleting model 'FormAnswer'
        db.delete_table('profile_formanswer')

        # Removing M2M table for field response on 'Person'
        db.delete_table('profile_person_response')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 24, 5, 50, 16, 891237)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'response': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profile.FormResponse']", 'symmetrical': 'False'}),
