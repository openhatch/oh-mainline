...
class Migration:
    ...
    def backwards(self, orm):
        ...
        # Deleting unique_together for [project, data_import_attempt] on RepositoryCommitter.
        db.delete_unique('profile_repositorycommitter', ['project_id', 'data_import_attempt_id'])
        
        # Deleting model 'RepositoryCommitter'
        db.delete_table('profile_repositorycommitter')
        
        # Dropping ManyToManyField 'Person.blacklisted_repository_committers'
        db.delete_table('profile_person_blacklisted_repository_committers')
        
        # Deleting field 'Citation.ignored_due_to_duplicate'
        db.delete_column('profile_citation', 'ignored_due_to_duplicate')
        
        # Deleting field 'DataImportAttempt.web_response'
        db.delete_column('profile_dataimportattempt', 'web_response_id')
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 3, 20, 8, 44, 540855)))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 3, 20, 8, 44, 655796)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 11, 3, 20, 8, 44, 789612)))
        db.alter_column('profile_citation', 'date_created', orm['profile.citation:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 5, 16, 25, 14, 117042)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 5, 16, 25, 13, 868366)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 5, 16, 25, 13, 518378)'}),
