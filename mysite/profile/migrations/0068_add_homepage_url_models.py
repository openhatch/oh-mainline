...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.homepage_url'
        db.add_column('profile_person', 'homepage_url', orm['profile.person:homepage_url'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.homepage_url'
        db.delete_column('profile_person', 'homepage_url')
