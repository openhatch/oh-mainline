...
class Migration:
    ...
    def forwards(self, orm):
        ...
        pfes  = orm['profile.portfolioentry'].objects.filter(is_deleted=False).filter(project__name='Debian')
        if pfes:
            real_debian = orm['search.project'].objects.get(
                name='Debian GNU/Linux')
            for pfe in pfes:
                pfe.project = real_debian
                pfe.save()
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 27, 23, 16, 14, 346041)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 27, 23, 16, 13, 551502)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 27, 23, 16, 14, 222775)'}),
