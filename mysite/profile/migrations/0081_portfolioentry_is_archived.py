...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PortfolioEntry.is_archived'
        db.add_column('profile_portfolioentry', 'is_archived', orm['profile.portfolioentry:is_archived'])
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 23, 7, 46, 557138)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 23, 7, 47, 285245)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'PortfolioEntry.sort_order'
        # (to signature: django.db.models.fields.IntegerField(default=0))
        db.alter_column('profile_portfolioentry', 'sort_order', orm['profile.portfolioentry:sort_order'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 23, 7, 47, 375549)))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PortfolioEntry.is_archived'
        db.delete_column('profile_portfolioentry', 'is_archived')
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 21, 26, 49, 792855)))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 21, 26, 51, 74821)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        ...
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 4, 19, 21, 26, 50, 518838)))
        db.alter_column('profile_citation', 'date_created', orm['profile.citation:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 19, 23, 7, 49, 31638)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 19, 23, 7, 48, 411103)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 19, 23, 7, 47, 667176)'}),
