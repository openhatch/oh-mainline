...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.photo_thumbnail_30px_wide'
        db.add_column('profile_person', 'photo_thumbnail_30px_wide', orm['profile.person:photo_thumbnail_30px_wide'])
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 26, 21, 9, 37, 160878)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 26, 21, 9, 37, 985200)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 26, 21, 9, 38, 199320)))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Person.photo_thumbnail_30px_wide'
        db.delete_column('profile_person', 'photo_thumbnail_30px_wide')
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 10, 19, 57, 20, 666422)))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 10, 19, 57, 21, 208058)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 2, 10, 19, 57, 21, 82332)))
        db.alter_column('profile_citation', 'date_created', orm['profile.citation:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 2, 26, 21, 9, 40, 135387)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 2, 26, 21, 9, 39, 934760)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 2, 26, 21, 9, 38, 521796)'}),
