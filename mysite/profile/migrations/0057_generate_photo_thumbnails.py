...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for person in orm['profile.person'].objects.all():
            ...
            try:
                ...
                # This is an opportune time to delete photos that can't be read.
                django_person.photo = ''
            django_person.save()
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 3, 20, 8, 44, 789612)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 3, 20, 8, 44, 540855)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 11, 3, 20, 8, 44, 655796)'}),
