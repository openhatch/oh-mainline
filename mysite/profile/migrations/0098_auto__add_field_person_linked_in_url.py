...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.linked_in_url'
        db.add_column('profile_person', 'linked_in_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.linked_in_url'
        db.delete_column('profile_person', 'linked_in_url')
