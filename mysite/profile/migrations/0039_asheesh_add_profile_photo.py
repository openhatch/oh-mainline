...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('profile_person', 'photo', orm['profile.person:photo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('profile_person', 'photo')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 30, 16, 50, 8, 664083)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 30, 16, 50, 8, 663936)'}),
