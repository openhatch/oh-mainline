...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Icon'
        db.create_table('profile_icon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('display_name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('base_profile_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('icon_url', self.gf('django.db.models.fields.URLField')(max_length=255)),
        ))
        db.send_create_signal('profile', ['Icon'])


    def backwards(self, orm):
        
        # Deleting model 'Icon'
        db.delete_table('profile_icon')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 6, 9, 16, 9, 850425)', 'auto_now_add': 'True', 'blank': 'True'}),
