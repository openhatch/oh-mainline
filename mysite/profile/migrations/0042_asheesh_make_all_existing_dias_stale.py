...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DataImportAttempt.stale'
        db.add_column('profile_dataimportattempt', 'stale', orm['profile.dataimportattempt:stale'])
        # Any existing DIAs ought to be made "stale"
        for dia in orm['profile.dataimportattempt'].objects.all():
            dia.stale = True
            dia.save()
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'DataImportAttempt.stale'
        db.delete_column('profile_dataimportattempt', 'stale')
