...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectExp.modified'
        db.add_column('profile_projectexp', 'modified', orm['profile.projectexp:modified'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProjectExp.modified'
        db.delete_column('profile_projectexp', 'modified')
