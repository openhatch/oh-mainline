...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.is_updated'
        db.add_column('profile_person', 'is_updated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Person.zoho_id'
        db.add_column('profile_person', 'zoho_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.is_updated'
        db.delete_column('profile_person', 'is_updated')

        # Deleting field 'Person.zoho_id'
        db.delete_column('profile_person', 'zoho_id')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 31, 5, 29, 46, 167872)', 'auto_now_add': 'True', 'blank': 'True'}),
