...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.uploaded_to_zoho'
        db.add_column('profile_person', 'uploaded_to_zoho', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.uploaded_to_zoho'
        db.delete_column('profile_person', 'uploaded_to_zoho')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateField', [], {'default': 'datetime.date.today', 'auto_now_add': 'True', 'blank': 'True'}),
