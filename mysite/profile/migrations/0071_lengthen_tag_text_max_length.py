...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.homepage_url'
        # (to signature: django.db.models.fields.URLField(default='', max_length=200, blank=True))
        db.alter_column('profile_person', 'homepage_url', orm['profile.person:homepage_url'])
        
        # Changing field 'Tag.text'
        # (to signature: django.db.models.fields.CharField(max_length=255))
        db.alter_column('profile_tag', 'text', orm['profile.tag:text'])
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 1, 24, 21, 51, 37, 570827)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 1, 24, 21, 51, 38, 80794)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 1, 24, 21, 51, 38, 149364)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime.utcnow))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 24, 21, 51, 38, 668953)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 24, 21, 51, 38, 346879)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 1, 24, 21, 51, 38, 540341)'}),
