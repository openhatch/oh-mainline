...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.email_me_weekly_re_projects'
        db.add_column('profile_person', 'email_me_weekly_re_projects', orm['profile.person:email_me_weekly_re_projects'])
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 48, 538727)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 49, 259632)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 49, 349405)))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Person.email_me_weekly_re_projects'
        db.delete_column('profile_person', 'email_me_weekly_re_projects')
        
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 5, 10, 20, 17, 55, 60006)))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 5, 10, 20, 17, 54, 857886)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 5, 10, 20, 17, 54, 661820)))
        db.alter_column('profile_citation', 'date_created', orm['profile.citation:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 4, 15, 53, 50, 230204)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 4, 15, 53, 50, 982440)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 4, 15, 53, 50, 428877)'}),
