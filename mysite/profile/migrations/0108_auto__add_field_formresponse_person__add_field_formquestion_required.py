...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormResponse.person'
        db.add_column('profile_formresponse', 'person', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profile.Person']), keep_default=False)

        # Adding field 'FormQuestion.required'
        db.add_column('profile_formquestion', 'required', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FormResponse.person'
        db.delete_column('profile_formresponse', 'person_id')

        # Deleting field 'FormQuestion.required'
        db.delete_column('profile_formquestion', 'required')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 28, 10, 10, 56, 289357)', 'auto_now_add': 'True', 'blank': 'True'}),
