...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.latitude'
        db.add_column('profile_person', 'latitude', self.gf('django.db.models.fields.FloatField')(default=-37.3049962), keep_default=False)

        # Adding field 'Person.longitude'
        db.add_column('profile_person', 'longitude', self.gf('django.db.models.fields.FloatField')(default=-12.6790445), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.latitude'
        db.delete_column('profile_person', 'latitude')

        # Deleting field 'Person.longitude'
        db.delete_column('profile_person', 'longitude')
