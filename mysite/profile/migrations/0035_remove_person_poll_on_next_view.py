...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.add_column('profile_person', 'poll_on_next_web_view', orm['profile.person:poll_on_next_web_view'])
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 19, 13, 50, 2, 21960)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 19, 13, 50, 2, 21808)'}),
