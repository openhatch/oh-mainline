...
class Migration:
    ...
    models = {
        'profile.person': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'static/images/profile-photos/sufjan.jpg'", 'max_length': '100'}),
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 30, 19, 29, 30, 453735)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 30, 19, 29, 30, 453605)'}),
