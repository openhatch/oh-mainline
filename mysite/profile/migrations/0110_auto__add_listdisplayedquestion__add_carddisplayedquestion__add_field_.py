...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ListDisplayedQuestion'
        db.create_table('profile_listdisplayedquestion', (
        ...
        db.send_create_signal('profile', ['ListDisplayedQuestion'])

        # Adding model 'CardDisplayedQuestion'
        db.create_table('profile_carddisplayedquestion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.Person'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profile.FormQuestion'])),
        ))
        db.send_create_signal('profile', ['CardDisplayedQuestion'])

        # Adding field 'FormQuestion.display_name'
        db.add_column('profile_formquestion', 'display_name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100), keep_default=False)

        # Adding unique constraint on 'FormQuestion', fields ['name']
        db.create_unique('profile_formquestion', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FormQuestion', fields ['name']
        db.delete_unique('profile_formquestion', ['name'])

        # Deleting model 'ListDisplayedQuestion'
        db.delete_table('profile_listdisplayedquestion')

        # Deleting model 'CardDisplayedQuestion'
        db.delete_table('profile_carddisplayedquestion')

        # Deleting field 'FormQuestion.display_name'
        db.delete_column('profile_formquestion', 'display_name')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 6, 3, 46, 16, 154574)', 'auto_now_add': 'True', 'blank': 'True'}),
