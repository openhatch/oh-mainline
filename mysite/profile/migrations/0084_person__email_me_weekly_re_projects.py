...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 11, 2, 3, 10, 213175)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 11, 2, 3, 10, 986660)))
        ...
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 11, 2, 3, 11, 83227)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DataImportAttempt.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 50, 982440)))
        db.alter_column('profile_dataimportattempt', 'date_created', orm['profile.dataimportattempt:date_created'])
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 50, 428877)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2010, 6, 4, 15, 53, 50, 230204)))
        db.alter_column('profile_citation', 'date_created', orm['profile.citation:date_created'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 11, 2, 3, 11, 402269)'}),
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 11, 2, 3, 12, 758824)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 6, 11, 2, 3, 12, 850181)'}),
