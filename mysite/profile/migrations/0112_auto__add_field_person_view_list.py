...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.view_list'
        db.add_column('profile_person', 'view_list', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.view_list'
        db.delete_column('profile_person', 'view_list')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 10, 44, 57, 16986)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'view_list': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
