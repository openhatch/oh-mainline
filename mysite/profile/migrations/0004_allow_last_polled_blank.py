...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile_person', 'last_polled', models.DateTimeField(null=True, blank=True))
        
        # Changing field 'Person.time_record_was_created'
        db.alter_column('profile_person', 'time_record_was_created', models.DateTimeField(default=datetime.datetime(2009, 6, 18, 21, 24, 12, 707069)))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Person.time_record_was_created'
        db.alter_column('profile_person', 'time_record_was_created', models.DateTimeField(default=datetime.datetime(2009, 6, 18, 21, 23, 9, 350135)))
    ...
    models = {
        'profile.person': {
            ...
            'time_record_was_created': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 6, 18, 21, 24, 12, 967616)'}),
