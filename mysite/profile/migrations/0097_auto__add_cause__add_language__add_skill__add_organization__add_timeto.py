...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Skill'
        db.create_table('profile_skill', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100)),
        ))
        db.send_create_signal('profile', ['Skill'])
        ...
        # Adding model 'TimeToCommit'
        db.create_table('profile_time_to_commit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=100)),
        ))
        db.send_create_signal('profile', ['TimeToCommit'])

        # Adding field 'Person.company_name'
        db.add_column('profile_person', 'company_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Person.opensource'
        db.add_column('profile_person', 'opensource', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Person.time_to_commit'
        db.add_column('profile_person', 'time_to_commit', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['profile.TimeToCommit']), keep_default=False)

        # Adding M2M table for field skill on 'Person'
        db.create_table('profile_person_skill', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profile.person'], null=False)),
            ('skill', models.ForeignKey(orm['profile.skill'], null=False))
        ))
        db.create_unique('profile_person_skill', ['person_id', 'skill_id'])

        # Adding M2M table for field organization on 'Person'
        db.create_table('profile_person_organization', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profile.person'], null=False)),
            ('organization', models.ForeignKey(orm['profile.organization'], null=False))
        ))
        db.create_unique('profile_person_organization', ['person_id', 'organization_id'])

        # Adding M2M table for field cause on 'Person'
        db.create_table('profile_person_cause', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profile.person'], null=False)),
            ('cause', models.ForeignKey(orm['profile.cause'], null=False))
        ))
        db.create_unique('profile_person_cause', ['person_id', 'cause_id'])

        # Adding M2M table for field language on 'Person'
        db.create_table('profile_person_language', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm['profile.person'], null=False)),
            ('language', models.ForeignKey(orm['profile.language'], null=False))
        ))
        db.create_unique('profile_person_language', ['person_id', 'language_id'])


    def backwards(self, orm):
        
        # Deleting model 'Cause'
        db.delete_table('profile_cause')

        # Deleting model 'Language'
        db.delete_table('profile_language')

        # Deleting model 'Skill'
        db.delete_table('profile_skill')

        # Deleting model 'Organization'
        db.delete_table('profile_organization')

        # Deleting model 'TimeToCommit'
        db.delete_table('profile_time_to_commit')

        # Deleting field 'Person.company_name'
        db.delete_column('profile_person', 'company_name')

        # Deleting field 'Person.opensource'
        db.delete_column('profile_person', 'opensource')

        # Deleting field 'Person.time_to_commit'
        db.delete_column('profile_person', 'time_to_commit_id')

        # Removing M2M table for field skill on 'Person'
        db.delete_table('profile_person_skill')

        # Removing M2M table for field organization on 'Person'
        db.delete_table('profile_person_organization')

        # Removing M2M table for field cause on 'Person'
        db.delete_table('profile_person_cause')

        # Removing M2M table for field language on 'Person'
        db.delete_table('profile_person_language')
    ...
    models = {
        ...
        'profile.person': {
            ...
            'skill': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['profile.Skill']", 'symmetrical': 'False'}),
