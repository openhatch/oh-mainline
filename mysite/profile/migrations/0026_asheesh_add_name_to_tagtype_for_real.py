...
class Migration:
    ...
    models = {
        'profile.person': {
            ...
            'time_record_was_created': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 6, 14, 20, 5, 155192)'}),
        ...
        'profile.link_person_tag': {
            ...
            'time_record_was_created': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 6, 14, 20, 5, 830341)'})
        },
        'profile.tag': {
            'id': ('models.AutoField', [], {'primary_key': 'True'}),
        ...
        'profile.link_projectexp_tag': {
            ...
            'source': ('models.CharField', [], {'max_length': '200'}),
            'tag': ('models.ForeignKey', ["orm['profile.Tag']"], {}),
            'time_record_was_created': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 6, 14, 20, 5, 729116)'})
        },
        ...
        'profile.link_project_tag': {
            ...
            'source': ('models.CharField', [], {'max_length': '200'}),
            'tag': ('models.ForeignKey', ["orm['profile.Tag']"], {}),
            'time_record_was_created': ('models.DateTimeField', [], {'default': 'datetime.datetime(2009, 7, 6, 14, 20, 5, 617922)'})
        },
