...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profile_person', 'date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Person.date_added'
        db.alter_column('profile_person', 'date_added', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'profile.person': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 21, 8, 7, 33, 272267)', 'auto_now_add': 'True', 'blank': 'True'}),
