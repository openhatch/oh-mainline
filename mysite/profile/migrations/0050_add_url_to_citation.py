...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Citation.first_commit_time'
        db.add_column('profile_citation', 'first_commit_time', orm['profile.citation:first_commit_time'])
        
        # Adding field 'Citation.url'
        db.add_column('profile_citation', 'url', orm['profile.citation:url'])
        
        # Deleting field 'Citation.year_started'
        db.delete_column('profile_citation', 'year_started')
        
        # Changing field 'PortfolioEntry.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 10, 23, 19, 22, 45, 8949)))
        db.alter_column('profile_portfolioentry', 'date_created', orm['profile.portfolioentry:date_created'])
        
        # Changing field 'Citation.languages'
        # (to signature: django.db.models.fields.CharField(max_length=200, null=True))
        db.alter_column('profile_citation', 'languages', orm['profile.citation:languages'])
        
        # Changing field 'Citation.date_created'
        # (to signature: django.db.models.fields.DateTimeField(default=datetime.datetime(2009, 10, 23, 19, 22, 45, 64537)))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Citation.first_commit_time'
        db.delete_column('profile_citation', 'first_commit_time')
        
        # Deleting field 'Citation.url'
        db.delete_column('profile_citation', 'url')
        
        # Adding field 'Citation.year_started'
        db.add_column('profile_citation', 'year_started', orm['profile.citation:year_started'])
    ...
    models = {
        ...
        'profile.citation': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 10, 23, 19, 22, 45, 668175)'}),
        ...
        'profile.portfolioentry': {
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 10, 23, 19, 22, 45, 234835)'}),
