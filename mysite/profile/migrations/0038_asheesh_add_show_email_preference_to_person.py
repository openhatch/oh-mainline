...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.show_email'
        db.add_column('profile_person', 'show_email', orm['profile.person:show_email'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Person.show_email'
        db.delete_column('profile_person', 'show_email')
