...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('search_buildhelper', (
            ...
            ('default_frustration_handler', self.gf('django.db.models.fields.URLField')(default='', max_length=200)),
        ...
        db.create_table('search_buildhelperstep', (
            ...
            ('frustration_handler', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('modified_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('hint', self.gf('django.db.models.fields.URLField')(default='http://cuteoverload.com', max_length=200, blank=True)),
