...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WrongIcon.project'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['search.Project']))
        db.alter_column('search_wrongicon', 'project_id', orm['search.wrongicon:project'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'WrongIcon.project'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['search.Project'], null=True))
        db.alter_column('search_wrongicon', 'project_id', orm['search.wrongicon:project'])
