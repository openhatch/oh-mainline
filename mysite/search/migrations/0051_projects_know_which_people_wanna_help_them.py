...
class Migration:
    ...
    def backwards(self, orm):
        ...
        # Dropping ManyToManyField 'Project.people_who_wanna_help'
        db.delete_table('search_project_people_who_wanna_help')
    ...
    models = {
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 3, 16, 20, 52, 34, 721323)'}),
