...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [canonical_bug_link] on Bug.
        db.create_unique('search_bug', ['canonical_bug_link'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [canonical_bug_link] on Bug.
        db.delete_unique('search_bug', ['canonical_bug_link'])
    ...
    models = {
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 4, 4, 18, 25, 55, 912540)'}),
