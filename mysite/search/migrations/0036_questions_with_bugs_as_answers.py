...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('search_buganswer', (
            ('id', orm['search.buganswer:id']),
            ('url', orm['search.buganswer:url']),
            ('title', orm['search.buganswer:title']),
            ('details', orm['search.buganswer:details']),
            ('author', orm['search.buganswer:author']),
            ('question', orm['search.buganswer:question']),
            ('project', orm['search.buganswer:project']),
        ))
