...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('search_notethatsomeonewantstohelpaproject', (
            ('id', orm['search.notethatsomeonewantstohelpaproject:id']),
            ('created_date', orm['search.notethatsomeonewantstohelpaproject:created_date']),
            ('modified_date', orm['search.notethatsomeonewantstohelpaproject:modified_date']),
            ('person', orm['search.notethatsomeonewantstohelpaproject:person']),
            ('project', orm['search.notethatsomeonewantstohelpaproject:project']),
        ))
        db.send_create_signal('search', ['NoteThatSomeoneWantsToHelpAProject'])
        
        # Creating unique_together for [project, person] on NoteThatSomeoneWantsToHelpAProject.
        db.create_unique('search_notethatsomeonewantstohelpaproject', ['project_id', 'person_id'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [project, person] on NoteThatSomeoneWantsToHelpAProject.
        db.delete_unique('search_notethatsomeonewantstohelpaproject', ['project_id', 'person_id'])
    ...
    models = {
        ...
        'search.notethatsomeonewantstohelpaproject': {
