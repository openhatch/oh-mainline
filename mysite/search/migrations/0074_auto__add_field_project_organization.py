...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('search_project', 'organization', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['base.Organization']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.organization'
        db.delete_column('search_project', 'organization_id')
