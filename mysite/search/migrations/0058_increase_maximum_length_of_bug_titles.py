...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bug.title'
        # (to signature: django.db.models.fields.CharField(max_length=500))
        db.alter_column('search_bug', 'title', orm['search.bug:title'])
        
        # Changing field 'Project.icon_raw'
        # (to signature: django.db.models.fields.files.ImageField(default=None, max_length=100, null=True, blank=True))
        db.alter_column('search_project', 'icon_raw', orm['search.project:icon_raw'])
        
        # Changing field 'Project.language'
        # (to signature: django.db.models.fields.CharField(default='', max_length=200, blank=True))
        db.alter_column('search_project', 'language', orm['search.project:language'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.icon_raw'
        # (to signature: django.db.models.fields.files.ImageField(default=None, max_length=100, null=True))
        db.alter_column('search_project', 'icon_raw', orm['search.project:icon_raw'])
    ...
    models = {
        ...
        'profile.dataimportattempt': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 5, 14, 23, 39, 32, 445573)'}),
