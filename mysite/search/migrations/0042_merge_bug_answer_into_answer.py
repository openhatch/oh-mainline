...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Answer.title'
        db.add_column('search_answer', 'title', orm['search.answer:title'])
        
        # Deleting model 'buganswer'
        db.delete_table('search_buganswer')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Answer.title'
        db.delete_column('search_answer', 'title')
        
        # Adding model 'buganswer'
        db.create_table('search_buganswer', (
            ('project', orm['search.answer:project']),
            ('modified_date', orm['search.answer:modified_date']),
            ('details', orm['search.answer:details']),
            ('author', orm['search.answer:author']),
            ('title', orm['search.answer:title']),
            ('created_date', orm['search.answer:created_date']),
            ('question', orm['search.answer:question']),
            ('id', orm['search.answer:id']),
        ))
        db.send_create_signal('search', ['buganswer'])
