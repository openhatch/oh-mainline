...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('search_project', 'display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.display_name'
        db.delete_column('search_project', 'display_name')
