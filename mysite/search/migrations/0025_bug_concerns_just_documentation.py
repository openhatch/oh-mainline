...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.concerns_just_documentation'
        db.add_column('search_bug', 'concerns_just_documentation', orm['search.bug:concerns_just_documentation'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Bug.concerns_just_documentation'
        db.delete_column('search_bug', 'concerns_just_documentation')
