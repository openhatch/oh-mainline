...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BugAlert.query_string'
        db.add_column('search_bugalert', 'query_string', orm['search.bugalert:query_string'])
        
        # Deleting field 'BugAlert.query'
        db.delete_column('search_bugalert', 'query')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'BugAlert.query_string'
        db.delete_column('search_bugalert', 'query_string')
        
        # Adding field 'BugAlert.query'
        db.add_column('search_bugalert', 'query', orm['search.bugalert:query'])
