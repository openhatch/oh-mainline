...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.icon_smaller_for_badge'
        db.add_column('search_project', 'icon_smaller_for_badge', orm['search.project:icon_smaller_for_badge'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.icon_smaller_for_badge'
        db.delete_column('search_project', 'icon_smaller_for_badge')
