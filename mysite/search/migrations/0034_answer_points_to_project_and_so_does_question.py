...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.delete_column('search_answer', 'project_id')
        
        # Adding field 'ProjectInvolvementQuestion.project'
        db.add_column('search_projectinvolvementquestion', 'project', orm['search.projectinvolvementquestion:project'])
