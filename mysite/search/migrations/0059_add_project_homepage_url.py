...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.homepage'
        db.add_column('search_project', 'homepage', orm['search.project:homepage'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Project.homepage'
        db.delete_column('search_project', 'homepage')
