...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BugAnswer.url'
        db.delete_column('search_buganswer', 'url')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'BugAnswer.url'
        db.add_column('search_buganswer', 'url', orm['search.buganswer:url'])
