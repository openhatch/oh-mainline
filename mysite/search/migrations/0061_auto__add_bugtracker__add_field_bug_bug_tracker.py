...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('search_bugtracker', (
            ...
            ('module_name', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('class_name', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('bug_tracker_model_module', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('bug_tracker_model_class_name', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('bug_tracker_model_pk', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('search', ['BugTracker'])

        # Adding field 'Bug.bug_tracker'
        db.add_column('search_bug', 'bug_tracker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['search.BugTracker'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'BugTracker'
        db.delete_table('search_bugtracker')

        # Deleting field 'Bug.bug_tracker'
        db.delete_column('search_bug', 'bug_tracker_id')
