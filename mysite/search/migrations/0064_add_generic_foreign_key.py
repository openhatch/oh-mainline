...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.tracker_type'
        db.add_column('search_bug', 'tracker_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Bug.tracker_id'
        db.add_column('search_bug', 'tracker_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bug.tracker_type'
        db.delete_column('search_bug', 'tracker_type_id')

        # Deleting field 'Bug.tracker_id'
        db.delete_column('search_bug', 'tracker_id')
