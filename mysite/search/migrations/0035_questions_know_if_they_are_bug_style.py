...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProjectInvolvementQuestion.is_bug_style'
        db.add_column('search_projectinvolvementquestion', 'is_bug_style', orm['search.projectinvolvementquestion:is_bug_style'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'ProjectInvolvementQuestion.is_bug_style'
        db.delete_column('search_projectinvolvementquestion', 'is_bug_style')
