...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.duration'
        db.add_column('search_project', 'duration', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['base.Duration']), keep_default=False)

        # Adding M2M table for field languages on 'Project'
        db.create_table('search_project_languages', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['search.project'], null=False)),
            ('language', models.ForeignKey(orm['base.language'], null=False))
        ))
        db.create_unique('search_project_languages', ['project_id', 'language_id'])

        # Changing field 'Project.organization'
        db.alter_column('search_project', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['base.Organization']))


    def backwards(self, orm):

        # Deleting field 'Project.duration'
        db.delete_column('search_project', 'duration_id')

        # Removing M2M table for field languages on 'Project'
        db.delete_table('search_project_languages')

        # Changing field 'Project.organization'
        db.alter_column('search_project', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Organization'], null=True))
    ...
    models = {
        ...
        'search.project': {
            ...
            'duration': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.Duration']"}),
