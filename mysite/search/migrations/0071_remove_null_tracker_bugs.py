...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # I know this is written in a very slow fashion, but I am under the
        # impression that MySQL and maybe other databases might not support
        # querying for NULL under some circumstances. This code only runs
        # once, so I hope it is not a big deal.
        for bug in orm.Bug.objects.all():
            if bug.tracker_id is None:
                bug.delete()

    def backwards(self, orm):
        "Write your backwards methods here."
        pass  # There is no way to go back.
