...
urlpatterns = patterns('',
                       ...
                       (r'^customs/add/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url$',
                        'mysite.customs.views.add_tracker_url'),
                       (r'^customs/add/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url/do$',
                        'mysite.customs.views.add_tracker_url_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url/(?P<url_id>\d*)/do$',
                        'mysite.customs.views.edit_tracker_url_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url/(?P<url_id>\d+)$',
                        'mysite.customs.views.edit_tracker_url'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/do$',
                        'mysite.customs.views.edit_tracker_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)$',
                        'mysite.customs.views.edit_tracker'),
                       (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)$',
                        'mysite.customs.views.delete_tracker'),
                       (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)$',
                        'mysite.customs.views.delete_tracker_do'),
                       (r'^customs/delete_url/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url/(?P<url_id>\d*)$',
                        'mysite.customs.views.delete_tracker_url'),
                       (r'^customs/delete_url/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/url/(?P<url_id>\d*)/do$',
