...
urlpatterns = patterns('',
        ...
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/(?P<url_id>\d*)$', 'mysite.customs.views.delete_tracker_url'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/(?P<url_id>\d*)/do$', 'mysite.customs.views.delete_tracker_url_do'),
