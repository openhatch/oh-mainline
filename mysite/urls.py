...
urlpatterns = patterns('',
                       ...
                       (r'^\+test_email_re_projects/',
                        'mysite.base.views.test_email_re_projects'),

                       (r'^\+project_icon_poll/(?P<project_name>.+)',
                        'mysite.search.views.project_has_icon'),

                       (r'^\+unsubscribe/(?P<token_string>.+)',
                       ...
                       (r'^missions/$',
                        'mysite.missions.base.views.main_page'),
                       (r'^missions/tar$', 'mysite.missions.tar.views.about'),
                       (r'^missions/tar/reset$',
                        'mysite.missions.tar.views.reset'),
                       (r'^missions/tar/unpacking$',
                        'mysite.missions.tar.views.unpacking'),
                       (r'^missions/tar/creating$',
                       ...
                       (r'^missions/diffpatch/single_diff$',
                        'mysite.missions.diffpatch.views.single_file_diff'),
                       (r'^missions/diffpatch/single_patch$',
                        'mysite.missions.diffpatch.views.single_file_patch'),
                       (r'^missions/diffpatch/recursive_diff$',
                       ...
                       (r'^missions/diffpatch/patchsingle/add-oven-temp.patch$',
                        'mysite.missions.diffpatch.views.patchsingle_get_patch'),
                       (r'^missions/diffpatch/patchsingle/submit$',
                        'mysite.missions.diffpatch.views.patchsingle_submit'),
                       (r'^missions/diffpatch/diffsingle/nutty-pancake.txt$',
                        'mysite.missions.diffpatch.views.diffsingle_get_original_file'),
                       (r'^missions/diffpatch/diffsingle/submit$',
                        'mysite.missions.diffpatch.views.diffsingle_submit'),
                       (r'^missions/diffpatch/diffrecursive/recipes.tar.gz$',
                        'mysite.missions.diffpatch.views.diffrecursive_get_original_tarball'),
                       (r'^missions/diffpatch/diffrecursive/submit$',
                        'mysite.missions.diffpatch.views.diffrecursive_submit'),
                       (r'^missions/diffpatch/patchrecursive/recipes.patch$',
                       ...
                       (r'^missions/svn$', mysite.missions.svn.views.MainPage.as_view(),
                        None, 'svn_main_page'),
                       (r'^missions/svn/description$',
                        mysite.missions.svn.views.LongDescription.as_view(
                        ), None, 'svn_long_description'),
                       (r'^missions/svn/checkout$',
                        mysite.missions.svn.views.Checkout.as_view(
                        ), None, 'svn_checkout'),
                       (r'^missions/svn/diff$',
                        mysite.missions.svn.views.Diff.as_view(
                        ), None, 'svn_diff'),
                       (r'^missions/svn/commit$',
                        mysite.missions.svn.views.Commit.as_view(
                        ), None, 'svn_commit'),
                       (r'^missions/svn/resetrepo$',
                        'mysite.missions.svn.views.resetrepo'),
                       (r'^missions/svn/checkout/submit$',
                       ...
                       (r'^missions/git/description$',
                        'mysite.missions.git.views.long_description'),
                       (r'^missions/git/description/submit$',
                        'mysite.missions.git.views.long_description_submit'),
                       (r'^missions/git/checkout$',
                        'mysite.missions.git.views.checkout'),
                       (r'^missions/git/resetrepo$',
                        'mysite.missions.git.views.resetrepo'),
                       (r'^missions/git/checkout/submit$',
                        'mysite.missions.git.views.checkout_submit'),
                       (r'^missions/git/diff$',
                        'mysite.missions.git.views.diff'),
                       (r'^missions/git/diff/submit$',
                        'mysite.missions.git.views.diff_submit'),
                       (r'^missions/git/rebase$',
                       ...
                       (r'^missions/irc/about$',
                        'mysite.missions.irc.views.about'),
                       (r'^missions/irc/joining$',
                        'mysite.missions.irc.views.joining'),
                       (r'^missions/irc/irc$',
                        'mysite.missions.irc.views.irc_secrets'),
                       (r'^missions/irc$',
                       ...
                       (r'^customs/add/(?P<tracker_type>\w*)/do$',
                        'mysite.customs.views.add_tracker_do'),
                       (r'^customs/add/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>[^/]+)/url$',
                        'mysite.customs.views.add_tracker_url'),
                       (r'^customs/add/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/do$',
                        'mysite.customs.views.add_tracker_url_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/(?P<url_id>\d*)/do$',
                        'mysite.customs.views.edit_tracker_url_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/(?P<url_id>\d+)$',
                        'mysite.customs.views.edit_tracker_url'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/do$',
                        'mysite.customs.views.edit_tracker_do'),
                       (r'^customs/edit/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)$',
                        'mysite.customs.views.edit_tracker'),
                       (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)$',
                        'mysite.customs.views.delete_tracker'),
                       (r'^customs/delete/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/do$',
                        'mysite.customs.views.delete_tracker_do'),
                       (r'^customs/delete_url/(?P<tracker_type>\w*)/(?P<tracker_id>\d+)/(?P<tracker_name>.+)/url/(?P<url_id>\d*)$',
                       ...
                       (r'^\+theme-stubs/wordpress/index$',
                        'mysite.base.views.wordpress_index'),

                       (r'^\+landing/import$',
                        'mysite.base.views.landing_for_documenters'),
                       (r'^\+landing/opps$',
                        'mysite.base.views.landing_for_opp_hunters'),
                       (r'^\+landing/projects$',
                        'mysite.base.views.landing_for_project_maintainers'),

                       (r'^search/$', 'mysite.search.views.search_index'),
                       ...
                       (r'^\+people/list/$', lambda x:
                        HttpResponsePermanentRedirect('/people/')),

                       (r'^account/proxyconnect-sso$',
                        'mysite.account.views.proxyconnect_sso'),
                       ...
                       (r'^account/signup/do$',
                        'mysite.account.views.signup_do'),
                       ...
                       url(r'^openid/signin/$',
                           django_authopenid.views.signin, name='user_signin'),
                       ...
                       url(r'^openid/register/do$',
                           'mysite.account.views.register'),

                       (r'^openid/', include('django_authopenid.urls')),

                       url(r'^account/forgot_pass_confirm/(?P<uidb36>[^/]+)/(?P<token>[^/]+)/$', 'django.contrib.auth.views.password_reset_confirm',
                           {'template_name': 'account/password_reset_confirm.html', 'post_reset_redirect': '/account/forgot_pass_complete/'}, name='password_reset_confirm'),

                       (r'^account/forgot_pass_done/', 'django.contrib.auth.views.password_reset_done',
                        {'template_name': 'account/password_reset_done.html'}),

                       (r'^account/forgot_pass_complete/', 'django.contrib.auth.views.password_reset_complete',
                      ...
                      (r'^\+portfolio/editor/$',
                       ...
                       (r'^people/[$]username[/]*$',
                        'mysite.profile.views.dollar_username'),
                       (r'^\+me$', 'mysite.profile.views.dollar_username', {},
                        'oh_my_profile_redirect'),

                       (r'^\+do/project.views.create_answer_do$',
                        'mysite.project.views.create_answer_do'),
                       (r'^\+do/project.views.delete_paragraph_answer_do$',
                        'mysite.project.views.delete_paragraph_answer_do'),

                       (r'^\+do/search.views.subscribe_to_bug_alert_do$',
                       ...
                       (r'^\+project/(?P<project__name>.+)',
                        'mysite.project.views.redirect_project_to_projects'),

                       (r'^\+do/project.views.create_project_page_do$',
                        'mysite.project.views.create_project_page_do'),

                       (r'^\+yo_is_django_alive$',
                        lambda x: HttpResponse('success')),

                       (r'^\+bitesize$', lambda x:
                        HttpResponseRedirect(
                            '/search/?q=&toughness=bitesize')),

                       (r'^\+geocode$', 'mysite.base.views.geocode'),

                       (r'^edit/name$', lambda x:
                        redirect(
                            to=mysite.account.views.edit_name, permanent=True)),

                       (r'^\+v/nextsteps4helpers/$',
                        'mysite.project.views.nextsteps4helpers'),
