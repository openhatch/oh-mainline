...
urlpatterns = patterns('',
        ...
        (r'^customs/edit/(?P<tracker_type>\w*)/(?P<project_name>\w*)/url/(?P<url_id>\d*)$', 'mysite.customs.views.edit_tracker_url'),
        (r'^customs/edit/(?P<tracker_type>\w*)/(?P<project_name>\w*)/url/(?P<url_id>\d*)/do$', 'mysite.customs.views.edit_tracker_url_do'),
        ...
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w*)/url/(?P<url_id>\d*)$', 'mysite.customs.views.delete_tracker_url'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w*)/url/(?P<url_id>\d*)/do$', 'mysite.customs.views.delete_tracker_url_do'),
