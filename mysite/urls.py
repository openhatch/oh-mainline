...
urlpatterns = patterns('',
        ...
        (r'^missions/tar$', 'mysite.missions.tar.views.tar_mission_about'),
        (r'^missions/tar/unpacking$', 'mysite.missions.tar.views.tar_mission_unpacking'),
        (r'^missions/tar/creating$', 'mysite.missions.tar.views.tar_mission_creating'),
        (r'^missions/tar/hints$', 'mysite.missions.tar.views.tar_mission_hints'),
        (r'^missions/tar/upload$', 'mysite.missions.tar.views.tar_upload'),
        (r'^missions/tar/downloadfile/(?P<name>.*)', 'mysite.missions.tar.views.tar_file_download'),
        (r'^missions/tar/downloadtarball', 'mysite.missions.tar.views.tar_download_tarball_for_extract_mission'),
        (r'^missions/tar/extractupload', 'mysite.missions.tar.views.tar_extract_mission_upload'),

        (r'^missions/diffpatch$', 'mysite.missions.diffpatch.views.diffpatch_mission_about'),
        (r'^missions/diffpatch/single_diff$', 'mysite.missions.diffpatch.views.diffpatch_mission_single_file_diff'),
        (r'^missions/diffpatch/single_patch$', 'mysite.missions.diffpatch.views.diffpatch_mission_single_file_patch'),
        (r'^missions/diffpatch/recursive_diff$', 'mysite.missions.diffpatch.views.diffpatch_mission_recursive_diff'),
        (r'^missions/diffpatch/recursive_patch$', 'mysite.missions.diffpatch.views.diffpatch_mission_recursive_patch'),
        (r'^missions/diffpatch/patchsingle/original$', 'mysite.missions.diffpatch.views.diffpatch_patchsingle_get_original_file'),
        (r'^missions/diffpatch/patchsingle/patch$', 'mysite.missions.diffpatch.views.diffpatch_patchsingle_get_patch'),
        (r'^missions/diffpatch/patchsingle/submit$', 'mysite.missions.diffpatch.views.diffpatch_patchsingle_submit'),
        (r'^missions/diffpatch/diffsingle/original$', 'mysite.missions.diffpatch.views.diffpatch_diffsingle_get_original_file'),
        (r'^missions/diffpatch/diffsingle/submit$', 'mysite.missions.diffpatch.views.diffpatch_diffsingle_submit'),
        (r'^missions/diffpatch/diffrecursive/original$', 'mysite.missions.diffpatch.views.diffpatch_diffrecursive_get_original_tarball'),
        (r'^missions/diffpatch/diffrecursive/submit$', 'mysite.missions.diffpatch.views.diffpatch_diffrecursive_submit'),
        (r'^missions/diffpatch/patchrecursive/original$', 'mysite.missions.diffpatch.views.diffpatch_patchrecursive_get_original_tarball'),
        (r'^missions/diffpatch/patchrecursive/patch$', 'mysite.missions.diffpatch.views.diffpatch_patchrecursive_get_patch'),
        (r'^missions/diffpatch/patchrecursive/submit$', 'mysite.missions.diffpatch.views.diffpatch_patchrecursive_submit'),

        (r'^missions/svn$', 'mysite.missions.svn.views.svn_mission_about'),
        (r'^missions/svn/resetrepo$', 'mysite.missions.svn.views.svn_resetrepo'),
        (r'^missions/svn/checkout$', 'mysite.missions.svn.views.svn_checkout'),
        (r'^missions/svn/checkout/submit$', 'mysite.missions.svn.views.svn_checkout_submit'),
        (r'^missions/svn/diff$', 'mysite.missions.svn.views.svn_diff'),
        (r'^missions/svn/diff/submit$', 'mysite.missions.svn.views.svn_diff_submit'),
        (r'^missions/svn/commit$', 'mysite.missions.svn.views.svn_commit'),
        (r'^missions/svn/commit/poll$', 'mysite.missions.svn.views.svn_commit_poll'),
        ...
        (r'^customs/edit/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/do$', 'mysite.customs.views.edit_tracker_do'),
        (r'^customs/edit/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/url/(?P<url_id>\d*)$', 'mysite.customs.views.edit_tracker_url'),
        (r'^customs/edit/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/url/(?P<url_id>\d*)/do$', 'mysite.customs.views.edit_tracker_url_do'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)$', 'mysite.customs.views.delete_tracker'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/do$', 'mysite.customs.views.delete_tracker_do'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/url/(?P<url_id>\d*)$', 'mysite.customs.views.delete_tracker_url'),
        (r'^customs/delete/(?P<tracker_type>\w*)/(?P<project_name>\w+(\s\w+)*)/url/(?P<url_id>\d*)/do$', 'mysite.customs.views.delete_tracker_url_do'),
